...
| [style.css: Line 147](https://github.com/benschaf/waste-schedule/blob/main/static/css/style.css#L147) | Gradient text | [cssgradient.io](https://cssgradient.io/blog/css-gradient-text/) |
| [style.css: Line 233](https://github.com/benschaf/waste-schedule/blob/main/static/css/style.css#L233) | timeline CSS & HTML | [www.bootdey.com](https://www.bootdey.com/snippets/view/timeline-events) |
| [style.css: Line 389](https://github.com/benschaf/waste-schedule/blob/main/static/css/style.css#L389) | progress bar | [bbbootstrap.com](https://bbbootstrap.com/snippets/bootstrap-4-bootstrap-4-timeline-order-tracking-step-step-progress-bar-26897417) |
...
| [style.css: Line 8](https://github.com/benschaf/waste-schedule/blob/main/staticfiles/css/style.css#L8) | using CSS root variables | [www.w3schools.com](https://www.w3schools.com/css/css3_variables.asp) |
| [style.css: Line 97](https://github.com/benschaf/waste-schedule/blob/main/staticfiles/css/style.css#L97) | keyframes | [stackoverflow.com](https://stackoverflow.com/questions/45330061/how-to-flash-a-div-only) |
| [style.css: Line 147](https://github.com/benschaf/waste-schedule/blob/main/staticfiles/css/style.css#L147) | Gradient text | [cssgradient.io](https://cssgradient.io/blog/css-gradient-text/) |
| [style.css: Line 232](https://github.com/benschaf/waste-schedule/blob/main/staticfiles/css/style.css#L232) | timeline CSS & HTML | [www.bootdey.com](https://www.bootdey.com/snippets/view/timeline-events) |
| [style.css: Line 389](https://github.com/benschaf/waste-schedule/blob/main/staticfiles/css/style.css#L389) | progress bar | [bbbootstrap.com](https://bbbootstrap.com/snippets/bootstrap-4-bootstrap-4-timeline-order-tracking-step-step-progress-bar-26897417) |
...
| [views.py: Line 22](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/views.py#L22) | class based views | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/ref/class-based-views/) |
| [views.py: Line 76](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/views.py#L76) | adding an annotation to each object in a list | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/topics/db/aggregation/) |
| [views.py: Line 79](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/views.py#L79) | passing only the id field value to the template | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/ref/models/querysets/#values-list) |
| [views.py: Line 103](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/views.py#L103) | additional context data in class based views | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/topics/class-based-views/generic-display/) |
| [views.py: Line 124](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/views.py#L124) | checking wether a queryset contains any items | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/ref/models/querysets/#django.db.models.query.QuerySet.exists) |
| [views.py: Line 125](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/views.py#L125) | authenticating the logged in user | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/topics/auth/default/#authentication-in-web-requests) |
| [views.py: Line 138](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/views.py#L138) | using the LoginRequiredMixin | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/topics/auth/default/#the-loginrequiredmixin-mixin) |
| [views.py: Line 173](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/views.py#L173) | finding class based view methods | [www.brennantymrak.com](https://www.brennantymrak.com/articles/createviewdiagram) |
| [views.py: Line 182](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/views.py#L182) | edit view | [github.com](https://github.com/Code-Institute-Solutions/blog/tree/main/12_views_part_3/05_edit_delete) |
| [views.py: Line 297](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/views.py#L297) | creating an object | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/topics/db/queries/#creating-objects) |
| [views.py: Line 298](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/views.py#L298) | deleting an object | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/topics/db/queries/#deleting-objects) |
| [views.py: Line 299](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/views.py#L299) | checking if an object exists | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/ref/models/querysets/#exists) |
| [views.py: Line 397](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/views.py#L397) | ics.py library that helps to create ics files | [icspy.readthedocs.io](https://icspy.readthedocs.io/en/stable) |
| [views.py: Line 412](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/views.py#L412) | formatting a date object width strftime | [strftime.org](https://strftime.org/) |
| [views.py: Line 419](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/views.py#L419) | creating a download response | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/ref/request-response/#fileresponse-objects) |
...
| [schedule_detail.html: Line 225](https://github.com/benschaf/waste-schedule/blob/main/wasteschedules/templates/wasteschedules/schedule_detail.html#L225) | sending JSON data to JavaScript | [docs.djangoproject.com](https://docs.djangoproject.com/en/5.0/ref/templates/builtins/#std-templatefilter-json_script) |
